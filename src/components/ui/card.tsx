  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glow: "bg-card border-primary/30 shadow-[0_0_30px_hsl(var(--primary)/0.1)]",
        elevated: "bg-card border-border shadow-2xl hover:shadow-[0_0_40px_hsl(var(--primary)/0.15)]",
      },
    },
    defaultVariants: {
      variant: "default",
